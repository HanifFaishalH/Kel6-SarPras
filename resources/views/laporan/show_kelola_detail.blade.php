...
<div class="modal-body">
    <form id="formDetailLaporan">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ $laporan->gedung->gedung_nama ?? 'N/A' }}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Lantai</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ $laporan->lantai->lantai_nama ?? 'N/A' }}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Ruang</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ $laporan->ruang->ruang_nama ?? 'N/A' }}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Sarana</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ $laporan->sarana->barang->barang_nama ?? 'Sarana #' . $laporan->sarana_id }}" readonly>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ ucfirst($laporan->tingkat_kerusakan) }}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Tingkat Urgensi</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ ucfirst($laporan->tingkat_urgensi) }}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Frekuensi Penggunaan</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ ucfirst($laporan->frekuensi_penggunaan) }}" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">Tanggal Operasional</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" value="{{ $laporan->tanggal_operasional }}" readonly>
            </div>
        </div>
    </form>
</div>
